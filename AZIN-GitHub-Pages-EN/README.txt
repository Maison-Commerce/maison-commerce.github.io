AZIN — ENGLISH HTML PROTOTYPE
Setup and sharing guide (English)

START HERE

This folder contains the English storefront prototype.
...
index.html   — the English interactive storefront
...
kept the same across languages; the interface itself is English.
